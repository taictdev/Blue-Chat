...
namespace Agora.Rtc
{
    public partial class MusicPlayerImpl
    {
        ...
        public int Open(int playerId, long songCode, long startPos = 0)
        {
            ...
            var nRet = AgoraRtcNative.CallIrisApiWithArgs(_irisApiEngine, AgoraApiType.IMUSICPLAYER_OPEN_303b92e,
        ...
        public int SetPlayMode(int playerId, MusicPlayMode mode)
        {
            ...
            var json = AgoraJson.ToJson(_param);
            var nRet = AgoraRtcNative.CallIrisApiWithArgs(_irisApiEngine, AgoraApiType.IMUSICPLAYER_SETPLAYMODE_748bee0,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
