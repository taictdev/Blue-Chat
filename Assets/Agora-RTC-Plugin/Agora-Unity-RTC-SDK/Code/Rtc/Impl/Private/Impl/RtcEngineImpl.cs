...
namespace Agora.Rtc
{
    ...
    public partial class RtcEngineImpl
    {
        ...
        private int CreateEventHandler()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IRTCENGINE_REGISTEREVENTHANDLER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int SetIrisAudioFrameObserver(AUDIO_FRAME_POSITION position)
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_REGISTERAUDIOFRAMEOBSERVER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int UnSetIrisAudioFrameObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_UNREGISTERAUDIOFRAMEOBSERVER failed: " + nRet);
            }
        ...
        private int SetIrisVideoFrameObserver(VIDEO_OBSERVER_FRAME_TYPE formatPreference, VIDEO_MODULE_POSITION position)
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_REGISTERVIDEOFRAMEOBSERVER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int UnSetIrisVideoFrameObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_UNREGISTERVIDEOFRAMEOBSERVER failed: " + nRet);
            }
        ...
        private int SetIrisVideoEncodedFrameObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_REGISTERVIDEOENCODEDFRAMEOBSERVER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int UnSetIrisVideoEncodedFrameObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_UNREGISTERVIDEOENCODEDFRAMEOBSERVER failed: " + nRet);
            }
        ...
        public int SetIrisFaceInfoObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_REGISTERFACEINFOOBSERVER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        public int UnSetIrisFaceInfoObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IMEDIAENGINE_UNREGISTERFACEINFOOBSERVER failed: " + nRet);
            }
        ...
        private int SetIrisMetaDataObserver(METADATA_TYPE type)
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IRTCENGINE_REGISTERMEDIAMETADATAOBSERVER failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int UnSetIrisMetaDataObserver()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IRTCENGINE_UNREGISTERMEDIAMETADATAOBSERVER failed: " + nRet);
            }
