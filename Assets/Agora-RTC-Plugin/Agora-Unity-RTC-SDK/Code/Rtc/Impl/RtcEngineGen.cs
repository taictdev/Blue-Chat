...
namespace Agora.Rtc
{
    public partial class RtcEngine : IRtcEngineEx
    {
        ...
        public override int SetFaceShapeBeautyOptions(bool enabled, FaceShapeBeautyOptions options, MEDIA_SOURCE_TYPE type = MEDIA_SOURCE_TYPE.PRIMARY_CAMERA_SOURCE)
        {
            ...
            return _impl.SetFaceShapeBeautyOptions(enabled, options, type);
        }
        ...
        public override int SetFaceShapeAreaOptions(FaceShapeAreaOptions options, MEDIA_SOURCE_TYPE type = MEDIA_SOURCE_TYPE.PRIMARY_CAMERA_SOURCE)
        {
            ...
            return _impl.SetFaceShapeAreaOptions(options, type);
        }
        ...
        public override int GetFaceShapeBeautyOptions(ref FaceShapeBeautyOptions options, MEDIA_SOURCE_TYPE type = MEDIA_SOURCE_TYPE.PRIMARY_CAMERA_SOURCE)
        {
            ...
            return _impl.GetFaceShapeBeautyOptions(ref options, type);
        }
        ...
        public override int GetFaceShapeAreaOptions(FACE_SHAPE_AREA shapeArea, ref FaceShapeAreaOptions options, MEDIA_SOURCE_TYPE type = MEDIA_SOURCE_TYPE.PRIMARY_CAMERA_SOURCE)
        {
            ...
            return _impl.GetFaceShapeAreaOptions(shapeArea, ref options, type);
        }
        ...
        public override int EnableVoiceAITuner(bool enabled, VOICE_AI_TUNER_TYPE type)
        {
            ...
            return _impl.EnableVoiceAITuner(enabled, type);
        }
        ...
        public override int StartLocalAudioMixer(LocalAudioMixerConfiguration config)
        {
            ...
            return _impl.StartLocalAudioMixer(config);
        }
        ...
        public override int UpdateLocalAudioMixerConfiguration(LocalAudioMixerConfiguration config)
        {
            ...
            return _impl.UpdateLocalAudioMixerConfiguration(config);
        }
        ...
        public override int StopLocalAudioMixer()
        {
            ...
            return _impl.StopLocalAudioMixer();
        }
        ...
        public override int QueryHDRCapability(VIDEO_MODULE_TYPE videoModule, ref HDR_CAPABILITY capability)
        {
            ...
            return _impl.QueryHDRCapability(videoModule, ref capability);
        }
